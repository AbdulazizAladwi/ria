...
} elseif ($_instance->childHasBeenRendered('KZPiIMn')) {
    $componentId = $_instance->getRenderedChildComponentId('KZPiIMn');
    $componentTag = $_instance->getRenderedChildComponentTagName('KZPiIMn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KZPiIMn');
} else {
    $response = \Livewire\Livewire::mount('invoice.payment-invoices.create', ['term_id' => $term_id]);
    $html = $response->html();
    $_instance->logRenderedChild('KZPiIMn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel-projects\ria\resources\views/dashboard/invoices/payment-invoices/create.blade.php ENDPATH**/ ?>