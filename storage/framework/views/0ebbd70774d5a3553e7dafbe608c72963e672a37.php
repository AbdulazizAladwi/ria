...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('css/prints/print.css')); ?>" />
    ...
    <tr>
        <td>
            <div class="print-head" style="">
                <img src="<?php echo e(url('css/prints/images/head.png')); ?>" style="width:100%;height:100%;" alt="">
            </div>
        </td>
    </tr>
    </thead>
            ...
            <div class="doc-body" style="position: relative;z-index: 1009;background: url(body.png) no-repeat 50% 50%;background-size: 50% auto;">
                ...
                <table class="mb-4">
                    <tr>
                        <td>
                            ...
                            <div class="plain-box text-center" style="padding-top: 5px"><?php echo e($receipt->number); ?></div>
                        </td>
                        <td class="align-right">
                            <p>date / التاريخ</p>
                            <div class="plain-box text-center" style="padding-top: 5px"><?php echo e($receipt->date); ?></div>
                        </td>
                    </tr>
                </table>
                <table class="table-pad nowrap">
                    <tr>
                        ...
                        <td>
                            <div class="dots-blk">
                                <?php echo e($receipt->invoice->paymentTerm->opportunity->client->name); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="dots-blk">
                                <?php echo e($receipt->invoice->amount); ?> <?php echo app('translator')->get('site.currency'); ?>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="dots-blk">
                                <?php echo e($receipt->invoice->paymentTerm->name); ?>
                            </div>
                        </td>
    ...
    <tr>
        <td>
            <div class="print-foot" style="">
                <img src="<?php echo e(url('css/prints/images/foot.png')); ?>" style="width:100%;height:100%;" alt="">
            </div>
        </td>
    </tr>
    </tfoot>
...
<?php /**PATH F:\laravel-projects\ria\resources\views/dashboard/invoices/prints/receipt.blade.php ENDPATH**/ ?>
