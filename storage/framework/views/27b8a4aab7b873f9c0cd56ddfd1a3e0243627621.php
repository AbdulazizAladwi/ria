...
} elseif ($_instance->childHasBeenRendered('DGIVsLo')) {
    $componentId = $_instance->getRenderedChildComponentId('DGIVsLo');
    $componentTag = $_instance->getRenderedChildComponentTagName('DGIVsLo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DGIVsLo');
} else {
    $response = \Livewire\Livewire::mount('invoice.payment-invoices.create', ['term_id' => $term_id]);
    $html = $response->html();
    $_instance->logRenderedChild('DGIVsLo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/Ahmed-Ibrahim/84D6EDAFD6EDA1A2/laravel projects/ria/resources/views/dashboard/invoices/payment-invoices/create.blade.php ENDPATH**/ ?>
