                ...
                <div class="form-row mb-3">
                    <div class="col-md-3">
                        ...
                        <select name="" wire:model="status" class="form-control">
                            <option value=""><?php echo app('translator')->get('site.select_status'); ?></option>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /media/Ahmed-Ibrahim/84D6EDAFD6EDA1A2/laravel projects/ria/resources/views/livewire/invoice/payment-invoices/create.blade.php ENDPATH**/ ?>
