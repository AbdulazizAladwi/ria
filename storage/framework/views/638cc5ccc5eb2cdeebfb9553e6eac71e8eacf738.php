...
} elseif ($_instance->childHasBeenRendered('feG7QGf')) {
    $componentId = $_instance->getRenderedChildComponentId('feG7QGf');
    $componentTag = $_instance->getRenderedChildComponentTagName('feG7QGf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('feG7QGf');
} else {
    $response = \Livewire\Livewire::mount('invoice.payment-invoices.edit', ['invoice' => $invoice]);
    $html = $response->html();
    $_instance->logRenderedChild('feG7QGf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Roqay\ria\resources\views/dashboard/invoices/payment-invoices/edit.blade.php ENDPATH**/ ?>