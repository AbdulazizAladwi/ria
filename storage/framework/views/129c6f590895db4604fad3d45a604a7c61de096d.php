    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(route('dashboard.costing.update',$proposal->id)); ?>" method="post">
            ...
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-dark btn-sm mx-1" id='btn' value='Print' onclick='printDiv();'><?php echo app('translator')->get('site.print'); ?></button>
...
<?php /**PATH /home/ranarabie/Work/BackEnd/RIA_internal/resources/views/livewire/costing/edit-cost.blade.php ENDPATH**/ ?>