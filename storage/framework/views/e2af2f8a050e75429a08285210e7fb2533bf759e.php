            ...
            <div class="p-2 bg-light mb-3" id="new_prescription_form">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                        <input onblur="findTotal()" type="text" name="margin" class="margin form-control" id="margin1" value="<?php echo e(old('margin')); ?>"/>
                        </td>
                        <td>%</td>
                    </tr>
                    <tr>
                        ...
                        <td>
                        <input onblur="finddis()" type="text" name="discount" class="margin form-control" id="margin2" value="<?php echo e(old('discount')); ?>"/>
                        </td>
                        <td>%</td>
                    </tr>
                    <tr>
...
</script><?php /**PATH C:\xampp\htdocs\Roqay\ria\resources\views/livewire/costing/add-cost.blade.php ENDPATH**/ ?>