...
} elseif ($_instance->childHasBeenRendered('coyrB2V')) {
    $componentId = $_instance->getRenderedChildComponentId('coyrB2V');
    $componentTag = $_instance->getRenderedChildComponentTagName('coyrB2V');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('coyrB2V');
} else {
    $response = \Livewire\Livewire::mount('costing.edit-cost',['proposal'=>$proposal]);
    $html = $response->html();
    $_instance->logRenderedChild('coyrB2V', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ranarabie/Work/BackEnd/RIA_internal/resources/views/dashboard/costing/edit.blade.php ENDPATH**/ ?>