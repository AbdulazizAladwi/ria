...
} elseif ($_instance->childHasBeenRendered('KKnZy3Y')) {
    $componentId = $_instance->getRenderedChildComponentId('KKnZy3Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('KKnZy3Y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KKnZy3Y');
} else {
    $response = \Livewire\Livewire::mount('invoice.payment-invoices.table', ['term_id' => $term_id]);
    $html = $response->html();
    $_instance->logRenderedChild('KKnZy3Y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel-projects\ria\resources\views/dashboard/invoices/payment-invoices/index.blade.php ENDPATH**/ ?>