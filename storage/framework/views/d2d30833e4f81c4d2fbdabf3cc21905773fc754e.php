    ...
    <div class="row">
        ...
        <?php if($maxPercent != 100): ?>
            <div class="col-md-5 text-right">
                <a href="<?php echo e(route('dashboard.invoice.payment-invoices.create', $term_id)); ?>" class="btn btn-primary text-capitalize float-btn">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="<?php echo e(route('dashboard.pdf.invoice', $invoice)); ?>" class="d-inline-block mx-1" target="_blank">
                                        <i class="icon-print2"></i>
                                    </a>
                                    <a href="<?php echo e(route('dashboard.docx.invoice', $invoice)); ?>" class="d-inline-block mx-1">
                                    ...
                                    <div class="d-flex align-items-center mt-2 justify-content-between">
                                        ...
                                        <div class="">
                                            <?php if($invoice->isCancelled()): ?>
                                                <a wire:click.prevent="regenerate(<?php echo e($invoice->id); ?>)" class="btn btn-info btn-sm" style="color: white"><?php echo app('translator')->get('site.regenerate'); ?></a>
                                            <?php elseif($invoice->isDelivered()): ?>
                                                <?php if( $invoice->hasReceipt() ): ?>
                                                    <span class="badge badge-success mr-2"><?php echo app('translator')->get('site.receipt_added'); ?></span>
                                                <?php else: ?>
...
<?php /**PATH F:\laravel-projects\ria\resources\views/livewire/invoice/payment-invoices/table.blade.php ENDPATH**/ ?>