...
} elseif ($_instance->childHasBeenRendered('f4TpDUP')) {
    $componentId = $_instance->getRenderedChildComponentId('f4TpDUP');
    $componentTag = $_instance->getRenderedChildComponentTagName('f4TpDUP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('f4TpDUP');
} else {
    $response = \Livewire\Livewire::mount('invoice.payment-invoices.table', ['term_id' => $term_id]);
    $html = $response->html();
    $_instance->logRenderedChild('f4TpDUP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ranarabie/Work/BackEnd/RIA_internal/resources/views/dashboard/invoices/payment-invoices/index.blade.php ENDPATH**/ ?>