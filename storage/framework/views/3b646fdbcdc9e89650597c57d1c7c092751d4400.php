...
} elseif ($_instance->childHasBeenRendered('58Z5GRU')) {
    $componentId = $_instance->getRenderedChildComponentId('58Z5GRU');
    $componentTag = $_instance->getRenderedChildComponentTagName('58Z5GRU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('58Z5GRU');
} else {
    $response = \Livewire\Livewire::mount('invoice.payment-invoices.table', ['term_id' => $term_id]);
    $html = $response->html();
    $_instance->logRenderedChild('58Z5GRU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/Ahmed-Ibrahim/84D6EDAFD6EDA1A2/laravel projects/ria/resources/views/dashboard/invoices/payment-invoices/index.blade.php ENDPATH**/ ?>
