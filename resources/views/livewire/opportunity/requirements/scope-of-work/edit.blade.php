        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="wrapper">
                        <div class="form-row">
                            ...
                            <div class="col-md-2 form-group">
                                ...
                                <input class="estimation-input form-control" type="number" wire:model.lazy="resourceSection.{{$i}}.pivot.estimation" min="1">
                ...
                <div class="form-row form-group mt-3">
                    <div class="col-md-1">
                        <a href="{{route('dashboard.scope-of-works.index', ['opportunity_id' => $opportunity->id, 'requirement_id' => $requirementId])}}" class="btn btn-primary ml-3">@lang('site.back')</a>
                    </div>
