                        ...
                        <div class="wrapper">
                            <div class="form-row align-items-end">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <input type="number"  wire:model.lazy="resourceSection.{{$i}}.estimation"  min="1" class="form-control">
                                    @error('estimation.' .$i.  '.estimation') <span class="error text-danger">{{ $message }}</span> @enderror
                                </div>

                                @if($i != 0)
                                <div class="col-md-1 form-group">
                                    <button wire:click.prevent="minusResourceSection( {{ $i }} )" style="height: 30px" class="btn btn-danger btn-sm  ml-3">
