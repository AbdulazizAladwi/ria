        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLongTitle">@lang('site.receipts')</h5>
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <table class="table">
                          <thead>
                                <tr>
                                  <th scope="col">@lang('site.number')</th>
                                  <th scope="col">@lang('site.date')</th>
                                  <th scope="col">@lang('site.file')</th>
                                </tr>
                          </thead>
                          <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>{{ $receipt->date ?? '-' }}</td>
                                  <td>
                                      <a href="{{route('dashboard.pdf.receipt', $receipt)}}" target="_blank">
