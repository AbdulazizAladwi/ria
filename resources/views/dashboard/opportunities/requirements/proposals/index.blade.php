                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                    <div class="right-actions">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('site.proposals')</li>
                        </ol>
                    </div>
                </div>
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            @livewire('opportunity.requirements.proposal.table', ['opportunity' => $opportunity, 'requirement' => $requirement])
        </div>
    </div>
@stop
