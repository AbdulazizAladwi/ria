                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                    <div class="right-actions">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('dashboard.proposals.index', ['requirement_id' => $requirementId, 'opportunity_id' =>$opportunity->id])}}">@lang('site.proposals')</a></li>
...
@section('content')
   ...
   @livewire('opportunity.requirements.proposal.create', [
        'title'             => $title,
