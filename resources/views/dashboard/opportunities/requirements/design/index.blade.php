                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                    <div class="right-actions">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('site.designs')</li>
                        </ol>
                    </div>
                </div>
            </div>
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            @livewire('opportunity.requirements.design.table', ['opportunityId' => $opportunityId, 'opportunity' => $opportunity, 'requirementId' => $requirementId])
        </div>
    </div>
@stop
