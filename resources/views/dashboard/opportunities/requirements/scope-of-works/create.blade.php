                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                    <div class="right-actions">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('dashboard.scope-of-works.index', ['requirement_id' => $requirementId, 'opportunity_id' =>$opportunity->id])}}">@lang('site.scope_of_works')</a></li>
...
@section('content')
    ...
    @livewire('opportunity.requirements.scope-of-work.create', [
    'title'             => $title,
