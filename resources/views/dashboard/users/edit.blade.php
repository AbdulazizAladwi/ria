...
@section('content')
    ...
    <div class="col-md-8 mx-auto">
        ...
        {!! Form::open(['route' => ['dashboard.users.update',$user->id]]) !!}
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('name', $user->name,['class' => 'form-control required','placeholder' => trans('site.name')]) !!}
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::email('email',$user->email,['class' => 'form-control required','placeholder' => trans('site.email')]) !!}
                        @error('email')
                        <p class="text-danger mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div style="text-align: right">
                    ...
                    <button type="submit" class="btn btn-secondary">@lang('site.update')</button>
                </div>
